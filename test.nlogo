...
to setup
  ...
  ;;Línea de ejemplo
  set ligera-dataset gis:load-dataset"AltitudLigera/AltitudLigera-polygon.shp"
  set estandar-dataset gis:load-dataset "AltitudEstandar/AltitudEstandar-polygon.shp"
  set elevada-dataset gis:load-dataset"AltitudElevada/AltitudElevada-polygon.shp"
  set muyElevada-dataset gis:load-dataset"AltitudMuyElevada/AreasAltitud-line.shp"
  ...
  gis:set-world-envelope (gis:envelope-union-of (gis:envelope-of terreno-dataset)
                                                ...
                                                (gis:envelope-of ligera-dataset)
                                                (gis:envelope-of estandar-dataset)
